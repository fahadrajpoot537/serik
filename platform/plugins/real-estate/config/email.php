...
return [
    ...
    'templates' => [
        ...
        'account-registered' => [
            'title' => 'VOW account registration PIN',
            'description' => 'Send the 6-digit login PIN to the user after VOW registration',
            'subject' => 'Your Serik Realty login PIN — {{ site_title }}',
            'can_off' => true,
            'enabled' => true,
            'variables' => [
