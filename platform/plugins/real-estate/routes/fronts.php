    ...
    Route::group(['namespace' => 'Botble\RealEstate\Http\Controllers\Fronts'], function (): void {
        ...
        Route::group(['middleware' => ['web', 'core', 'account', EnsureAccountIsApproved::class, 'account.not_blocked', LocaleMiddleware::class]], function (): void {
            Route::prefix('account')->name('public.account.')->group(function (): void {
                ...
                Route::match(['GET', 'POST'], 'visits', [\Botble\RealEstate\Http\Controllers\Fronts\AccountPropertyVisitController::class, 'index'])->name('visits.index');
                Route::post('visits/{id}/request-delete', [\Botble\RealEstate\Http\Controllers\Fronts\AccountPropertyVisitController::class, 'requestDelete'])->name('visits.request-delete')->wherePrimaryKey('id');
