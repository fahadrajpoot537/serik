...
use Botble\RealEstate\Http\Middleware\EnsureAccountRegistrationNotExpired;
    ...
    public function boot(): void
    {
        ...
        DashboardMenu::beforeRetrieving(function (): void {
            DashboardMenu::make()
                ...
                ->registerItem([
                    'id' => 'cms-plugins-real-estate-property-visits',
                    'priority' => 6,
                    'parent_id' => 'cms-plugins-real-estate',
                    'name' => 'plugins/real-estate::property-visit.name',
                    'icon' => 'ti ti-eye',
                    'url' => fn () => route('property-visit.index'),
                    'permissions' => ['property-visit.index'],
                ]);
        });
        ...
        DashboardMenu::for('account')->beforeRetrieving(function (DashboardMenuSupport $dashboardMenu): void {
            $dashboardMenu
                ...
                ->registerItem([
                    'id' => 'cms-account-visits',
                    'priority' => 3,
                    'name' => 'plugins/real-estate::property-visit.history',
                    'url' => fn () => route('public.account.visits.index'),
                    'icon' => 'ti ti-history',
                ])
                ->when(RealEstateHelper::isEnabledCreditsSystem(), function (DashboardMenuSupport $dashboardMenu): void {
                    $dashboardMenu
        ...
        $this->app->afterResolving(Schedule::class, function (Schedule $schedule): void {
            ...
            $schedule
                ->command(PurgeExpiredAccountsCommand::class)
                ->dailyAt('01:00');
        });
