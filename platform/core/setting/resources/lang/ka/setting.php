...
return [
    'title' => 'áƒžáƒáƒ áƒáƒ›áƒ”áƒ¢áƒ áƒ”áƒ‘áƒ˜',
    ...
    'license_title' => 'áƒšáƒ˜áƒªáƒ”áƒœáƒ–áƒ˜áƒ',
    ...
    'security' => [
        ...
        'step_4' => 'Clear cache using Admin Panel â†’ Platform Administration â†’ Cache Management',
    ...
    'cache' => [
        ...
        'form' => [
            ...
            'shortcode_cache_warning' => '<strong>âš ï¸ Important Notice:</strong><br>â€¢ Shortcodes containing forms (contact forms, newsletter subscriptions, etc.) will automatically bypass caching to preserve functionality.<br>â€¢ Shortcodes with dynamic JavaScript content should have caching disabled manually.<br>â€¢ To disable caching for specific shortcodes, add <code>Enable caching: No</code> to the shortcode configuration.<br>â€¢ Forms with CSRF tokens, reCAPTCHA, or other dynamic elements are automatically detected and excluded from caching.',
            ...
            'widget_cache_warning' => '<strong>âš ï¸ Important Notice:</strong><br>â€¢ Widgets containing forms (contact forms, newsletter subscriptions, etc.) will automatically bypass caching to preserve functionality.<br>â€¢ Widgets with dynamic JavaScript content should have caching disabled manually.<br>â€¢ To disable caching for specific widgets, set <code>Enable caching: No</code> in the widget configuration.<br>â€¢ Forms with CSRF tokens, reCAPTCHA, or other dynamic elements are automatically detected and excluded from caching.',
