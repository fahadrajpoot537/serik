...
return [
    ...
    'general' => [
        ...
        'time_zone_helper' => 'Seleziona il fuso orario per il tuo sito web. Questo verrÃ  utilizzato per tutte le visualizzazioni di data e ora in tutto il sistema',
        'enable' => 'Abilita',
        'disable' => 'Disabilita',
        ...
        'webmaster_tools_description' => 'Google Search Console Ã¨ uno strumento web gratuito fornito da Google che aiuta i proprietari di siti web a monitorare le prestazioni del loro sito nei risultati di ricerca di Google.',
        'yes' => 'SÃ¬',
        'no' => 'No',
        'show_on_front' => 'La tua homepage mostra',
        'select' => 'â€” Seleziona â€”',
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'admin_logo_max_height_helper' => 'Imposta l\'altezza del logo in pixel. Il valore predefinito Ã¨ :default.',
            'admin_favicon' => 'Favicon amministratore',
    ...
    'datatable' => [
        ...
        'form' => [
            'show_column_visibility' => 'Mostra visibilitÃ  colonne per impostazione predefinita',
            'show_column_visibility_helper' => 'Abilita il pulsante di attivazione della visibilitÃ  delle colonne nelle tabelle dati per consentire agli utenti di mostrare/nascondere colonne',
    ...
    'email' => [
        ...
        'sender_name_helper' => 'Il nome che apparirÃ  nel campo Da delle email inviate dal sistema',
        'sender_email' => 'Email mittente',
        'sender_email_placeholder' => 'Indirizzo email (es. :default)',
        'sender_email_helper' => 'L\'indirizzo email che verrÃ  utilizzato come mittente per tutte le email inviate dal sistema',
        'mailer' => 'Mailer',
        'port' => 'Porta',
        ...
        'queue_warning_description' => 'La tua coda email Ã¨ attualmente configurata per utilizzare il driver ":default", ma il tuo worker di coda potrebbe non essere in esecuzione. CiÃ² significa che le email non verranno inviate finchÃ© non configuri un worker di coda.',
        ...
        'mail_gun_secret_placeholder' => 'Es: YOUR_MAILGUN_PRIVATE_API_KEY',
        ...
        'local_domain_placeholder' => 'PuÃ² essere vuoto. Deve essere impostato sul tuo dominio quando usi SMTP Relay. Es. tuo-dominio.com',
        'local_domain_helper' => 'Il dominio che verrÃ  utilizzato per identificare il server durante la comunicazione con server SMTP remoti',
        'ses_key' => 'Chiave',
        ...
        'ses_region_helper' => 'La regione AWS dove Ã¨ configurato il tuo servizio SES',
        ...
        'default' => 'Predefinito',
        'template_off_status_helper' => 'Questo template email Ã¨ disattivato.',
        ...
        'email_template_logo_helper_text' => 'Se non impostato, verrÃ  preso dal logo amministratore in Admin -> Impostazioni -> Aspetto Admin -> Logo.',
        'email_template_copyright_text_helper_text' => 'Se non impostato, verrÃ  preso dal copyright opzioni tema in Admin -> Aspetto -> Opzioni Tema -> Generale -> Copyright.',
        'email_template_email_contact' => 'Indirizzo email di contatto',
        'email_template_email_contact_helper_text' => 'Se non impostato, verrÃ  preso dall\'email mittente in Admin -> Impostazioni -> Email',
    ...
    'media' => [
        ...
        'do_spaces_cdn_enabled' => 'Ãˆ abilitato DO Spaces CDN?',
        'do_spaces_cdn_enabled_helper' => 'Se abilitati, i file multimediali verranno serviti tramite la CDN DigitalOcean Spaces per una distribuzione globale piÃ¹ rapida dei contenuti. Facoltativamente, puoi configurare un dominio CDN personalizzato di seguito.',
        ...
        'backblaze_cdn_enabled' => 'Ãˆ abilitato Backblaze CDN?',
        'backblaze_cdn_enabled_helper' => 'Se abilitati, i file multimediali verranno serviti tramite una CDN per una distribuzione dei contenuti globale piÃ¹ rapida. Ãˆ necessario configurare un dominio CDN personalizzato di seguito (ad esempio, Cloudflare CDN o Backblaze CDN).',
        ...
        'enable_watermark_helper' => 'Se abilitato, una filigrana verrÃ  automaticamente aggiunta alle immagini appena caricate nelle cartelle selezionate. CiÃ² non influisce sulle immagini esistenti.',
        ...
        'watermark_opacity' => 'OpacitÃ  Filigrana (%)',
        ...
        'all' => 'Tutti',
        'all_helper_text' => 'Se deselezioni tutte le cartelle, verrÃ  applicato a tutte le cartelle.',
        ...
        'keep_original_file_size_and_quality' => 'Mantieni dimensione e qualitÃ  file originale',
        'keep_original_file_size_and_quality_helper' => 'Se abilitate, le immagini caricate non verranno ridimensionate o ottimizzate, preservando la qualitÃ  e la dimensione del file originali. Se disabilitato, le immagini potrebbero essere compresse e ridimensionate in base alle impostazioni.',
        ...
        'thumbnail_crop_position_helper' => 'Questa impostazione viene utilizzata per ritagliare l\'immagine durante la generazione delle miniature. VerrÃ  ritagliata da questa posizione fino a quando l\'immagine Ã¨ riempita.',
        ...
        'enable_thumbnail_sizes_helper' => 'Abilita questa opzione per generare miniature per le immagini. Se Ã¨ disabilitata, il sistema non genererÃ  miniature per le immagini e utilizzerÃ  sempre l\'immagine a dimensione intera.',
        'convert_image_to_webp' => 'Converti immagine JPG, JPEG, PNG in WebP',
        'convert_image_to_webp_helper' => 'WebP Ã¨ un formato di immagine moderno che fornisce compressione lossless e lossy superiore per le immagini sul web. Ãˆ supportato in Chrome, Firefox, Edge e Opera. L\'immagine verrÃ  convertita in formato WebP durante il caricamento. Ãˆ applicato solo per immagini JPG, JPEG, PNG.',
        'reduce_large_image_size' => 'Riduci dimensione immagini grandi durante il caricamento',
        'reduce_large_image_size_helper' => 'Quando abilitato, il sistema ridurrÃ  la dimensione delle immagini grandi durante il caricamento, applicato per immagini JPG, JPEG, PNG, WebP. La larghezza e l\'altezza massime dell\'immagine verranno ridimensionate ai valori impostati di seguito.',
        ...
        'image_max_width_helper' => 'Imposta la larghezza massima dell\'immagine in pixel. La larghezza originale verrÃ  mantenuta se questo campo Ã¨ vuoto.',
        'image_max_height_helper' => 'Imposta l\'altezza massima dell\'immagine in pixel. L\'altezza originale verrÃ  mantenuta se questo campo Ã¨ vuoto.',
        'customize_upload_path' => 'Personalizza percorso caricamento',
        'customize_upload_path_helper' => 'Personalizza il percorso di caricamento per i file multimediali. Per impostazione predefinita, il sistema caricherÃ  i file nella cartella ":path".',
        'upload_path' => 'Percorso caricamento',
        'upload_path_placeholder' => 'Esempio: uploads',
        'upload_path_helper' => 'Quella cartella verrÃ  creata in /public. La cartella predefinita Ã¨ ":folder". Quindi verrÃ  caricata in "/public/:folder".',
        'upload_path_warning' => 'Il sistema non sposterÃ  i file esistenti nella nuova cartella. Se vuoi spostare i file esistenti nella nuova cartella, devi farlo manualmente.',
        'convert_file_name_to_uuid' => 'Converti nome file in UUID',
        'convert_file_name_to_uuid_helper' => 'Quando abilitato, il sistema convertirÃ  il nome del file in UUID durante il caricamento. Ãˆ utile per prevenire nomi di file duplicati e migliorare la sicurezza.',
    ...
    'generate_thumbnails_error' => 'Non Ã¨ stato possibile rigenerare le miniature per :count file!',
    ...
    'watermark_description' => 'ATTENZIONE: La filigrana viene aggiunta solo alle nuove immagini caricate, non verrÃ  aggiunta alle immagini esistenti. La disabilitazione della filigrana non rimuoverÃ  la filigrana dalle immagini esistenti.',
    'submit' => 'Invia',
    'back' => 'Indietro',
    ...
    'cronjob' => [
        ...
        'is_working' => 'Congratulazioni! Il tuo cronjob Ã¨ in esecuzione.',
        'is_not_working' => 'Il tuo cronjob non Ã¨ in esecuzione. Controlla il cronjob del tuo server.',
        ...
        'setup' => [
            ...
            'done' => 'Il cronjob verrÃ  ora eseguito ogni minuto ed eseguirÃ  il comando specificato.',
            'learn_more' => 'Puoi saperne di piÃ¹ sul cronjob dalla :documentation di Laravel',
    ...
    'security' => [
        ...
        'http_security_headers_description' => 'Aggiunge header di sicurezza per proteggere contro vulnerabilitÃ  web comuni',
        'https_warning' => 'Il tuo sito non utilizza HTTPS',
        'https_warning_description' => 'Alcune funzionalitÃ  di sicurezza come i cookie sicuri richiedono HTTPS. Considera l\'abilitazione di SSL per il tuo sito web.',
        ...
        'step_4' => 'Svuota la cache usando Pannello Admin â†’ Amministrazione Piattaforma â†’ Gestione Cache',
        ...
        'learn_more' => 'Per informazioni piÃ¹ dettagliate, consulta la :documentation',
        'documentation' => 'documentazione di sicurezza',
    ],
    'cache' => [
        'title' => 'Cache',
        'description' => 'Configura la cache per velocitÃ  ottimizzata',
        'form' => [
            'cache_admin_menu' => 'Cache menu amministratore',
            'cache_admin_menu_helper' => 'Cache del menu amministratore per velocitÃ  ottimizzata. Questa opzione dovrebbe essere disabilitata se stai sviluppando o personalizzando il menu amministratore.',
            ...
            'cache_front_menu_helper' => 'Cache del menu frontend per velocitÃ  ottimizzata',
            'cache_user_avatar' => 'Cache avatar utente',
            'cache_user_avatar_helper' => 'Per gli utenti senza avatar, il sistema genererÃ  avatar dai loro nomi utente. Gli avatar verranno memorizzati in cache per velocitÃ  ottimizzata e non verranno rigenerati.',
            ...
            'shortcode_cache_warning' => '<strong>âš ï¸ Avviso Importante:</strong><br>â€¢ Gli shortcode contenenti moduli (moduli di contatto, iscrizioni newsletter, ecc.) ignoreranno automaticamente la cache per preservare la funzionalitÃ .<br>â€¢ Gli shortcode con contenuto JavaScript dinamico dovrebbero avere la cache disabilitata manualmente.<br>â€¢ Per disabilitare la cache per shortcode specifici, aggiungi <code>Abilita cache: No</code> alla configurazione dello shortcode.<br>â€¢ I moduli con token CSRF, reCAPTCHA o altri elementi dinamici vengono rilevati automaticamente ed esclusi dalla cache.',
            'shortcode_cache_ttl' => 'Durata cache (secondi)',
            'shortcode_cache_ttl_helper' => 'La durata per memorizzare in cache tutti gli shortcode. Predefinito Ã¨ 1800 secondi (30 minuti).',
            ...
            'widget_cache_warning' => '<strong>âš ï¸ Avviso Importante:</strong><br>â€¢ I widget contenenti moduli (moduli di contatto, iscrizioni newsletter, ecc.) ignoreranno automaticamente la cache per preservare la funzionalitÃ .<br>â€¢ I widget con contenuto JavaScript dinamico dovrebbero avere la cache disabilitata manualmente.<br>â€¢ Per disabilitare la cache per widget specifici, imposta <code>Abilita cache: No</code> nella configurazione del widget.<br>â€¢ I moduli con token CSRF, reCAPTCHA o altri elementi dinamici vengono rilevati automaticamente ed esclusi dalla cache.',
            'widget_cache_ttl' => 'Durata cache (secondi)',
            'widget_cache_ttl_helper' => 'La durata per memorizzare in cache tutti i widget. Predefinito Ã¨ 1800 secondi (30 minuti).',
            'plugin_cache_enabled' => 'Cache plugin installati',
            'plugin_cache_enabled_helper' => 'Memorizza in cache l\'elenco dei plugin installati per prestazioni migliorate. Quando abilitato, il sistema memorizzerÃ  in cache l\'elenco dei plugin per 30 minuti per ridurre le scansioni del file system.',
        ],
    ],
    'appearance' => [
        'title' => 'Aspetto',
