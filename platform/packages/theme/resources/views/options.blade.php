        ...
        >
            ...
            <x-core::card.body class="p-0">
                <div class="d-block d-md-flex">
                    ...
                    <script>
                          document.getElementById("opt-text-subsection-page-tab").style.display = "none";
                          document.getElementById("opt-text-subsection-facebook-integration-tab").style.display = "none";
                          document.getElementById("opt-text-subsection-blog-tab").style.display = "none";
                          document.getElementById("opt-text-subsection-career-seo-tab").style.display = "none";
                          document.getElementById("opt-text-subsection-real-estate-tab").style.display = "none";
