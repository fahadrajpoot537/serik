...
<link rel="stylesheet" href="{{ $serikThemeCss('homepage-premium.css') }}?v={{ get_cms_version() }}-hp69">
@endif
{{-- Site chrome last: shared navbar/footer + compact laptop scaling --}}
<link rel="stylesheet" href="{{ $serikThemeCss('site-chrome.css') }}?v={{ get_cms_version() }}-sc51">
        <script>
        (function () {
