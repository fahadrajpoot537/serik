        ...
        <div class="form-group-2 form-style form-search-location" data-bb-toggle="search-suggestion">
            ...
            <div class="position-relative">
                <div @class(['group-ip', 'ip-icon' => $style === 3])>
                    <input type="text" class="form-control" placeholder="Address, Street Name and MLS" value="{{ BaseHelper::stringify(request()->query('location')) }}" name="location" data-url="{{ route('public.ajax.cities') }}" />
