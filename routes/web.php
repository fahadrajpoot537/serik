...
// Canonical Terms page slug is term-and-conditions; keep old URLs working.
Route::redirect('/terms-of-service', '/term-and-conditions', 301);
Route::redirect('/terms-conditions', '/term-and-conditions', 301);
