            ...
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
                ...
                <tr>
                    <td style="padding:28px;">
                        ...
                        <p style="margin:0 0 16px;">Your appointment has been booked. We look forward to speaking with you.</p>
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin:16px 0 24px;">
                            ...
                            <tr>
                                ...
                                <td style="padding:8px 0;font-weight:bold;">{{ $bookingReference }}</td>
                            </tr>
                        </table>
                        <p style="margin:0 0 12px;">To reschedule or cancel, call {{ $officePhone }} or email {{ $officeEmail }} and include your booking reference.</p>
                        <p style="margin:0;">Thank you,<br>Serik Realty</p>
                    </td>
                </tr>
            </table>
        </td>
